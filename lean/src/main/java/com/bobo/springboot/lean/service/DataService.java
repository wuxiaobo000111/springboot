...
/**
 * Created by bobo on 2018/8/19/21:42.
 */
@Service
public class DataService {
     ...
     * 其中key 为 #id+dataMap
     */
    @Cacheable(value="wuxiaobo" ,key="#id +dataMap")
     ...
     * 其中key 为 #id+dataMap
     */
    @CachePut(value="wuxiaobo" ,key="#id +dataMap")
     ...
     * 其中key 为 #id+dataMap
     */
    @CacheEvict(value="wuxiaobo" , key="#id +dataMap")
